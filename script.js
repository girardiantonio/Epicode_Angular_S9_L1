...
const listReference = document.getElementById("list");
...
formReference.addEventListener("submit", (e) => {
    ...
    if (randomNumber === firstNumberValue) {
        ...
        if (n1 === n2) {
            ...
            generateListItem(`Nessuno dei giocatori ha indovinato il numero, ma i due giocatori hanno dato lo stesso numero e si sono avvicinati entrambi al numero random: ${randomNumber}`);
        }
        else if (n1 < n2) {
            generateListItem(`La differenza del giocatore 1: ${n1}`);
            generateListItem(`La differenza del giocatore 2: ${n2}`);
            generateListItem(`Nessuno dei giocatori ha indovinato il numero, ma il giocatore 1 si è avvicinato di più al numero random: ${randomNumber}`);
        }
        else {
            generateListItem(`La differenza del giocatore 1: ${n1}`);
            generateListItem(`La differenza del giocatore 2: ${n2}`);
            generateListItem(`Nessuno dei giocatori ha indovinato il numero, ma il giocatore 2 si è avvicinato di più al numero random: ${randomNumber}`);
        }
    }
});
